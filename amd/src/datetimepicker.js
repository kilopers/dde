define(['theme_boost/loader', 'jquery'], function (lll, $) {
    return {

        init: function (selector, TimepickerTrue, OnlyTime) {

            OnlyTime = typeof OnlyTime !== 'undefined' ? OnlyTime : false;

            var FormatTimePicker = 'd.m.Y H:i';
            var YearStart = 2010;
            var MySel = selector;
            var DatePickerActive = true;
            if(!TimepickerTrue) {
                FormatTimePicker = 'd.m.Y';
                YearStart = 1945;
            }
            if(OnlyTime)
            {
            ...
            var datetimepickerFactory = function ($) {
                ...
                var default_options  = {
                    ...
                    timepicker: TimepickerTrue,
                    datepicker: DatePickerActive,
                    weeks: false,
                    ...
                    onChangeDateTime: function () {this.data('input').trigger('change');},
                    onShow: function () {},
                    onClose: function () {},
                    onGenerate: function () {},
